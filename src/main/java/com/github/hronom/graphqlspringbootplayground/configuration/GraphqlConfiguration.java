package com.github.hronom.graphqlspringbootplayground.configuration;

import com.github.hronom.graphqlspringbootplayground.graphql.*;
    ...
    public PostDao postDao() {
        ...
        for (int postId = 0; postId < 10; ++postId) {
            for (int authorId = 0; authorId < 10; ++authorId) {
                ...
                post.setRandomNumber(random.nextInt(5));
                posts.add(post);
            }
        }
